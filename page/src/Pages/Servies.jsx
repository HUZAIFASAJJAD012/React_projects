const Servies = () => {
    return ( 
        ...
        <div id="features" class="mx-auto max-w-6xl">
          <h1 class="text-center font-display text-3xl font-bold tracking-tight text-[#010F52] md:text-4xl">
          Anything to anyone from anywhere           </h1>
          <h2 class="text-center font-display text-3xl  tracking-tight text-[#010F52] md:text-4xl">
          Get inspired while business with us
          </h2>
          <ul class="mt-16 grid grid-cols-1 gap-6 text-center text-slate-700 md:grid-cols-3">
            ...
            <li class="rounded-xl bg-white px-6 py-8 shadow-xl">
