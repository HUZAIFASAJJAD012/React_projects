import smart from "../component/images/Smartrfq.png";
    ...
    <section class="bg-white ">
      <div class="grid  px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div class="mr-auto place-self-center lg:col-span-7">
          ...
          <p class="max-w-2xl mb-6 font-light font-medium text-[#243A73] lg:mb-8 md:text-lg lg:text-xl ">
          ...
          <a
            href="#"
            class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-[#0E538C] dark:border-gray-700 dark:hover:bg-gray-700  dark:focus:ring-gray-800"
          >
            Speak to Sales
          </a>
        </div>
